package br.com.everty.product.presentation.product_search.preview
...
val productsHighlightsPreview = listOf(
    ProductModelUI(
        id = "1",
...
val productUIStatePreview = ProductUIState(
    productList = productsHighlightsPreview
)
